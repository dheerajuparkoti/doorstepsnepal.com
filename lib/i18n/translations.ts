export const translations = {
  en: {
    ...
    hero: {
      ...
      tutorialsGuide : "Tutorials & Guides",
    },
    // Search
    search: {
...
whyChoose: {
  ...
  easyBooking: "Easy Online Booking",
  easyBookingDesc: "Book services in just a few clicks from your phone or computer.",
  variety: "Variety of Services", 
  varietyDesc: "Wide range of home services under one roof", 
  customized: "Customized Solutions", 
  customizedDesc: "Tailored services to meet your specific needs", 
  accessibility: "Easy Accessibility", 
  accessibilityDesc: "Services available across multiple locations", 
  support: "24/7 Customer Support", 
  supportDesc: "Round-the-clock assistance for your queries", 
  quality: "Quality Guarantee", 
  qualityDesc: "100% satisfaction guaranteed on all services", 
  trusted: "Trusted Service", 
  trustedDesc: "Thousands of happy customers across Nepal", 
  emergency: 'Emergency Service',
emergencyDesc: '24/7 emergency service available for urgent needs',
},
  ...
  wallet: {
      ...
      sidebar: {
        ...
        payments: "Payments",
        myPayments: "My Payments",
        partnerBenefitProgram: "Service Fee & Benefits",
        settings: "Settings & Privacy",
        accountInfo: "Account Info",
          privacyPolicyProfessional: "Privacy Policy",
        appSettings: "App Settings",
        privacyCenter: "Privacy Center",
      },
      welcome: {
 ...
 onboarding: {
  ...
  ne: {
    ...
    hero: {
      ...
      tutorialsGuide : "ट्यूटोरियल्स र गाइडहरू",
    },
    // Search
    search: {
  ...
  variety: 'विविध सेवाहरू',
  varietyDesc: 'घरका सबै सेवाहरू एकै छानामुनि - सफेदीदेखि प्लम्बिङसम्म',
  customized: 'अनुकूलित समाधान',
  customizedDesc: 'तपाईंको आवश्यकता अनुसार विशेष सेवाहरू',
  accessibility: 'सहज पहुँच',
  accessibilityDesc: 'काठमाडौं उपत्यका र प्रमुख शहरहरूमा सेवा उपलब्ध',
  support: '२४/७ ग्राहक सहायता',
  supportDesc: 'जुनसुकै बेला हाम्रो सहयोग टोलीसँग सम्पर्क गर्नुहोस्',
  quality: 'गुणस्तर ग्यारेन्टी',
  qualityDesc: 'सबै सेवाहरूमा १००% सन्तुष्टिको ग्यारेन्टी',
  trusted: 'विश्वसनीय सेवा',
  trustedDesc: 'हजारौं सन्तुष्ट ग्राहकहरूको विश्वास',
    emergency: 'आपतकालिन सेवा',
  emergencyDesc: 'तत्काल आवश्यक परेमा २४/७ आपतकालिन सेवा उपलब्ध',
},
    // Footer
    footer: {
      ...
      cancellationRefundPolicy: "रद्दीकरण र रिफन्ड नीति",
      download:"डाउनलोड",
      support:"सहायता",
      account: "खाता",
    ...
    professional: {
      ...
      sidebar: {
        ...
        payments: "भुक्तानीहरू",
        myPayments: "मेरो भुक्तानीहरू",
        partnerBenefitProgram: "सेवा शुल्क तथा सुविधाहरू",
        settings: "सेटिङ्स र गोपनीयता",
        accountInfo: "खाता जानकारी",
                 privacyPolicyProfessional: "गोपनीयता नीति",
        appSettings: "एप सेटिङ्स",
        privacyCenter: "गोपनीयता केन्द्र",
      },
      welcome: {
