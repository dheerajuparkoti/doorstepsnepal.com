export const translations = {
  en: {
    ...
    footer: {
      ...
      privacyPolicyProfessional: "Professionals Privacy Policy",
      termsConditions: "Terms & Conditions",
      faqs: "FAQs",
      account: "Account",
      download:"Download",
            // copyright: "© 2024 Doorsteps Nepal. All rights reserved.",
    copyright: "Presented by © Tech Reeva Enterprise. All rights reserved.",
  ...
  wallet: {
    ...
    favorites: {
  title: "My Favorites",
  savedServicesProfessionals: "Your saved services and professionals",
  loginRequired: "Login Required",
  pleaseLoginToView: "Please login to view your favorite services and professionals.",
  ...
  startExploring: "Start exploring services and professionals. Click the heart icon to add them to your favorites.",
  browseServices: "Browse Services",
  ...
  authenticationRequired: "Authentication required. Please login to view favorites.",
  verified: "Verified",
  reviews: "reviews",
  remove: "Remove",
  view: "View",
 ...
 onboarding: {
  ...
  ne: {
    ...
    nav: {
      home: "होम",
      services: "सेवाहरू",
      professionals: "प्रोफेशनलहरू",
      aboutUs: "हाम्रो बारेमा",
      becomeProfessional: "प्रोफेशनल बन्नुहोस्",
       downloadApp : "डाउनलोड",
      login: "लग इन",
      signUp: "साइन अप",
      logout: "लग आउट",
    ...
    hero: {
      ...
      subheadline: "प्लम्बिङ, बिजुली, सफाई, सौन्दर्य, मर्मत र थप कार्यका लागि प्रमाणित प्रोफेशनलहरू बुक गर्नुहोस्। गुणस्तरीय सेवाको ग्यारेन्टी।",
    ...
    howItWorks: {
      ...
      step2Title: "प्रमाणित प्रोफेशनल पाउनुहोस्",
      step2Desc: "हामी तपाईंलाई तपाईंको क्षेत्रमा कुशल र प्रमाणित प्रोफेशनलहरूसँग मिलाउँछौं।",
      step3Title: "सेवा पछि भुक्तान गर्नुहोस्",
      step3Desc: "सेवा तपाईंको सन्तुष्टि अनुसार पूरा भएपछि मात्र भुक्तान गर्नुहोस्।",
    },
    // Professionals
    professionals: {
      title: "शीर्ष प्रोफेशनलहरू",
      viewAll: "सबै प्रोफेशनलहरू हेर्नुहोस्",
      verified: "प्रमाणित",
      rating: "रेटिङ",
      jobs: "कामहरू",
    ...
    //   verified: "प्रमाणित प्रोफेशनलहरू",
    //   verifiedDesc: "हाम्रा सबै प्रोफेशनलहरू तपाईंको सुरक्षाको लागि पृष्ठभूमि जाँच र प्रमाणित छन्।",
    //   affordable: "सस्तो मूल्य",
    //   affordableDesc: "पारदर्शी बिलिङको साथ प्रतिस्पर्धी मूल्यमा गुणस्तरीय सेवाहरू पाउनुहोस्।",
    //   onTime: "समयमै सेवा",
    //   onTimeDesc: "हाम्रा प्रोफेशनलहरू समयमा आइपुग्छन् र काम कुशलतापूर्वक पूरा गर्छन्।",
    ...
    // },
      ...
      heroDescription: 'हामी विश्वसनीय प्रोफेशनलहरूलाई घरधनीहरूसँग जोड्छौं, गुणस्तरीय सेवाहरू सबैका लागि पहुँचयोग्य, विश्वसनीय र सुविधाजनक बनाउँदै।',
      happyCustomers: 'खुसी ग्राहकहरू',
      happyProfessionals: 'खुसी प्रोफेशनलहरू',
      verifiedPros: 'प्रमाणित प्रोफेशनलहरू',
      services: 'सेवाहरू',
      ...
      missionDescription: 'प्रमाणित, कुशल प्रोफेशनलहरूसँग जोडेर प्रत्येक घरपरिवारलाई गुणस्तरीय घर सेवा पहुँचयोग्य बनाउनु।',
    ...
    whyChoose: {
      ...
      onTime: 'समयमै सेवा',
      onTimeDesc: 'हामी तपाईंको समयको कदर गर्छौं। हाम्रा प्रोफेशनलहरू निर्धारित समयमै आउँछन्।',
    ...
    footer: {
      ...
      aboutText: "Doorsteps Nepal ले तपाईंलाई तपाईंको सबै घरेलु सेवा आवश्यकताहरूको लागि प्रमाणित प्रोफेशनलहरूसँग जोड्छ। गुणस्तर, विश्वास, र सुविधा तपाईंको ढोकामा।",
      quickLinks: "द्रुत लिंकहरू",
      aboutUs: "हाम्रो बारेमा",
        location :  "हाम्रो स्थान",
      contactUs: "सम्पर्क गर्नुहोस्",
      privacyPolicy: "गोपनीयता नीति",
          privacyPolicyProfessional: "प्रोफेशनल गोपनीयता नीति",
      termsConditions: "नियम र सर्तहरू",
      faqs: "प्रश्नहरू",
      download:"डाउनलोड",
      account: "खाता",
      copyright: "Presented by © Tech Reeva Enterprise। सर्वाधिकार सुरक्षित।",
    },
    // Dashboard Common
    dashboard: {
      welcome: "स्वागत छ",
    ...
    customer: {
      sidebar: {
        ...
        accepted: "स्वीकृत",
        inspected: "निरीक्षित",
        awaitingApproval: "स्वीकृतिको प्रतीक्षा",
        completed: "पूरा भयो",
        cancelled: "रद्द भयो",
...
favorites: {
  ...
  savedServicesProfessionals: "तपाईंको बचत गरिएका सेवाहरू र प्रोफेशनलहरू",
  loginRequired: "लगइन आवश्यक",
  pleaseLoginToView: "कृपया आफ्ना मनपर्ने सेवाहरू र प्रोफेशनलहरू हेर्न लगइन गर्नुहोस्।",
  goToLogin: "लगइन गर्न जानुहोस्",
  backToHome: "गृह पृष्ठमा फर्कनुहोस्",
  tryAgain: "पुनः प्रयास गर्नुहोस्",
  services: "सेवाहरू",
  professionals: "प्रोफेशनलहरू",
  noFavoritesYet: "अहिलेसम्म कुनै मनपर्ने छैन",
  startExploring: "सेवाहरू र प्रोफेशनलहरू अन्वेषण गर्न सुरु गर्नुहोस्। तिनीहरूलाई मनपर्नेमा थप्न हृदय आइकनमा क्लिक गर्नुहोस्।",
  browseServices: "सेवाहरू ब्राउज गर्नुहोस्",
  findProfessionals: "प्रोफेशनलहरू फेला पार्नुहोस्",
  removeConfirm: "के तपाईं निश्चित हुनुहुन्छ कि तपाईं यसलाई मनपर्नेबाट हटाउन चाहनुहुन्छ?",
  removeFailed: "मनपर्ने हटाउन असफल भयो। कृपया पुनः प्रयास गर्नुहोस्।",
  loadFailed: "मनपर्नेहरू लोड गर्न असफल भयो। कृपया पुनः प्रयास गर्नुहोस्।",
  authenticationRequired: "प्रमाणीकरण आवश्यक छ। कृपया मनपर्ने हेर्न लगइन गर्नुहोस्।",
  verified: "सत्यापित",
  reviews: "समीक्षाहरू",
  remove: "हटाउनुहोस्",
  view: "हेर्नुहोस्",
