...
// import { Wrench, RefreshCw, ArrowRight, Briefcase, Package, Clock } from 'lucide-react';
...
//     const slug = createProfessionalSlug(service.professional.user.full_name, service.professional_id);
...
//       {/* Header with stats - like customer dashboard */}
//       <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
//         <div>
//           <div className="flex items-center gap-3 mb-2">
//             <div className="h-8 w-1 bg-gradient-to-b from-primary/60 to-primary rounded-full" />
...
//       {/* Stats cards - like customer dashboard */}
...
//                 {language === 'ne' ? `${totalPriceOptions} मूल्य विकल्प` : `${totalPriceOptions} price options`}
//               </Badge>
//             </div>
//             <div className="mt-3">
//               <p className="text-2xl font-bold">{services.length}</p>
//               <p className="text-sm text-muted-foreground">
//                 {language === 'ne' ? 'कुल सेवाहRs.' : 'Total Services'}
//               </p>
//             </div>
//           </CardContent>
//         </Card>
...
//                 {language === 'ne' ? 'सुरु मूल्य' : 'starting from'}
//               </Badge>
//             </div>
//             <div className="mt-3">
//               <p className="text-2xl font-bold">
//                 Rs. {Math.min(...services.flatMap(s => s.prices.map(p => p.price))).toLocaleString()}
//               </p>
//               <p className="text-sm text-muted-foreground">
//                 {language === 'ne' ? 'सबैभन्दा सस्तो मूल्य' : 'Best Price'}
//               </p>
//             </div>
//           </CardContent>
//         </Card>
...
//       {/* Services List - like recent activity style */}
//       <div className="space-y-4">
//         <div className="flex items-center gap-2">
//           <div className="h-5 w-1 bg-primary/40 rounded-full" />
//           <h3 className="font-medium text-foreground">
//             {language === 'ne' ? 'उपलब्ध सेवाहRs.' : 'Available Services'}
//           </h3>
//           <Badge variant="secondary" className="ml-2 bg-primary/5 text-xs">
//             {services.length}
//           </Badge>
//         </div>
...
//               <Card 
//                 key={service.id} 
//                 className="hover:shadow-md transition-all duration-200 cursor-pointer border-border/50 hover:border-primary/20 group"
  ...
  const handleServiceClick = async (service: ProfessionalService) => {
    ...
    if (service.prices.length === 0) return;
     ...
     const professionalSlug = createProfessionalSlug(service.professional.user.full_name, service.professional_id);
      ...
      // router.push(`/professionals/${slug}/services/${service.id}`);

  // Create service slug from service name
  const serviceName =service.service?.name_en || 'service';
  
  const serviceSlug = createServiceSlug(serviceName, service.id);

  // Navigate to URL with professional slug + service slug
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-secondary/20 via-secondary/5 to-background border border-border/50 p-12">
        ...
        <div className="relative text-center space-y-6 max-w-md mx-auto">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              {language === 'ne' 
                ? 'यस पेशेवरले हाल कुनै सेवा प्रदान गरेका छैनन्' 
