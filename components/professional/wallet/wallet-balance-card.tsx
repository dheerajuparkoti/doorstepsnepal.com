    ...
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary to-primary-600 text-primary-foreground">
      ...
      <div className="relative p-6 md:p-8">
        ...
        {isEligible && (
          <button
            onClick={onWithdraw}
            className="w-full flex items-center justify-center space-x-2 px-6 py-3.5 bg-gray-800 dark:bg-gray-800 hover:bg-gray-500 dark:hover:bg-gray-700 text-secondary-600 dark:text-white font-semibold rounded-xl transition-all transform hover:scale-[1.02] active:scale-[0.98]"
          >
