...
// app/services/service-section.tsx
'use client';
...
export function ServicesClient({
  ...
  return (
    <div className="min-h-screen bg-background">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                {categoriesData.map((category) => (
                  <Badge
                    key={category.id}
                    variant={selectedCategory?.id === category.id ? "default" : "outline"}
                    className="cursor-pointer px-3 py-2 text-sm justify-center"
                    onClick={() => {
                      if (selectedCategory?.id === category.id) {
                        setSelectedCategory(null);
                      } else {
                ...
                return (
                  ...
                  >
                    ...
                    <CardContent className="p-4">
                      ...
                      {/* Professionals Row with Avatars (like Flutter) */}
      ...
      {/* Professionals Dialog (like Flutter's bottom sheet) */}
      <Dialog open={showProfessionalsDialog} onOpenChange={setShowProfessionalsDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>
