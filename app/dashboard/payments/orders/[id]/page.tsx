...
//           className="inline-flex items-center space-x-2 px-6 py-2.5 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors shadow-sm"
//         >
//           <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          >
            ...
            {getLocalizedText('Back to Order', 'अर्डरमा फर्कनुहोस्')}
          </button>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
            {getLocalizedText('Payment Collections', 'भुक्तानी संग्रह')}
          </h1>
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            {getLocalizedText('Order #', 'अर्डर #')}{id}
          </p>
        </div>
      ...
      <div className="flex items-center justify-between mt-8 mb-4">
        <div className="flex items-center space-x-2">
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
            {getLocalizedText('All Payments', 'सबै भुक्तानीहरू')}
          </h2>
        </div>
        <span className="px-2.5 py-1 text-xs font-medium bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded-full">
          {payments.length} {getLocalizedText('Payments', 'भुक्तानीहरू')}
        </span>
      </div>
      ...
      {payments.length === 0 ? (
        <div className="bg-white dark:bg-gray-800 rounded-xl p-12 text-center border border-gray-200 dark:border-gray-700">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
            {getLocalizedText('No payments yet', 'कुनै भुक्तानी छैन')}
          </h3>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            {getLocalizedText('Add your first payment to this order', 'यस अर्डरमा पहिलो भुक्तानी थप्नुहोस्')}
          </p>
        </div>
      ) : (
        <MasonryGrid
      ...
      {!isFullyPaid && !hasPendingPayments && paymentSummary && (
        <div className="mt-6 text-center">
          ...
          >
            ...
            <span>{getLocalizedText('Add Payment', 'भुक्तानी थप्नुहोस्')}</span>
          </button>
        </div>
      )}
